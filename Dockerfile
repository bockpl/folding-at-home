...
LABEL maintainer="seweryn.sitarski@gmail.com"
...
ADD config.xml /home/folder/config.xml
RUN chown folder:folder /home/folder/config.xml &&\
    rm -rf /tmp/* /var/log/* /var/lib/apt/ /var/cache/apt/ 
...
CMD ["--config=/home/folder/config.xml"]
